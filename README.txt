...
Status messages usually appear when a content item has been affected (created, edited,
removed, state changed etc.) in some way. They appear to the user effecting the
change.
...
users who are notified, are the users with a local 'Editor' role on the object 
being affected.
